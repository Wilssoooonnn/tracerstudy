                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        @for ($i = 1; $i <= 5; $i++)
                                            <label class="mr-2">
                                                <input type="radio" name="kerjasama" value="{{ $i }}" required> {{ $i }}
                                            </label>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        @for ($i = 1; $i <= 5; $i++)
                                            <label class="mr-2">
                                                <input type="radio" name="etos_kerja" value="{{ $i }}" required> {{ $i }}
                                            </label>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>3. Kemampuan berkomunikasi (lisan/tulisan & bahasa asing)</label>
                                    <div>
                                        @for ($i = 1; $i <= 5; $i++)
                                            <label class="mr-2">
                                                <input type="radio" name="kemampuan_bahasa" value="{{ $i }}" required> {{ $i }}
                                            </label>
                                        @endfor
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>4. Penguasaan bidang IT sesuai kebutuhan pekerjaan</label>
                                    <div>
                                        @for ($i = 1; $i <= 5; $i++)
                                            <label class="mr-2">
                                                <input type="radio" name="kemampuan_it" value="{{ $i }}" required> {{ $i }}
                                            </label>
                                        @endfor
                                    </div>
                                </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="btnConfirmSubmit">Ya,
                                            Simpan</button>
                                    </div>
                                </div>
                            </div>
